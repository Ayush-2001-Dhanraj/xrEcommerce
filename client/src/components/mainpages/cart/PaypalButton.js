...
export default class PaypalButton extends React.Component {
  render () {
    ...
    const total = this.props.total // same as above, this is the total amount (based on currency) to be paid by using Paypal express checkout
    // Document on Paypal's currency code: https://developer.paypal.com/docs/classic/api/currency_codes/

    const client = {
      sandbox: 'AToPsjURQboXHDYq4bDSLNbCIijgYRuegd2VlDM59OHldHXEpOofgzyji5bs4AcgR5sixTcJ9l55gR2T',
